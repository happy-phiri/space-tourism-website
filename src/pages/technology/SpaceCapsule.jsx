...
const SpaceCapsule = () => {
  ...
  const spaceCapsuleData =
    data.find((item) => item.name.toLowerCase().includes("capsule")) || [];
  useDocumentTitle("Technology | Space Capsule - Space Tourism Website");
