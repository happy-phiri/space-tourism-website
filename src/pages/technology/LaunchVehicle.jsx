...
const LaunchVehicle = () => {
  ...
  const launchVehicleData =
    data.find((item) => item.name.toLowerCase().includes("launch")) || [];
  useDocumentTitle("Technology | Launch Vehicle - Space Tourism Website");
